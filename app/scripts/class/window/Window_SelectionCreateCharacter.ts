...
import {
	ICharacterMenuInfo,
	IWindowSelectionCreateCharacterOption,
} from "../../definitions/class/Window/IWindowSelectionCreateCharacter";
...
export default class Window_SelectionCreateCharacter extends Window_Base {
	...
	public init(option: IWindowSelectionCreateCharacterOption): void {
		super.init(option);
